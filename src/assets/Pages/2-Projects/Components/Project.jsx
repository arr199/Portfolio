...
export const Project = ({ title, description, imgUrl, technologies, children, link }) => {
            ...
            { hover
              ? <motion.div {...fadeAnimation()} className='absolute top-2 lg:p-4 p-2 inset-0 m-auto flex flex-col lg:gap-2 gap-1'>
                ...
                <motion.div className='flex  h-full items-end  justify-between gap-1'>
                    <motion.a href={link} target='_blank' {...slideAnimation('right', 0.6)} className='bg-gray-800  text-gray-50 lg:text-inherit text-sm p-[5px] lg:px-4 py-2 rounded-3xl '>Try it !</motion.a>
